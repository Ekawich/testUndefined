...
import { TextField, Stack, Modal, Typography, Button, Box, Alert } from "@mui/material";
...
const FormModal = (props) => {
	...
	return (
		<div>
			<Modal open={props.onOpen} onClose={closeModal} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
				<Box sx={style} component="form" onSubmit={(e) => submitHandler(e)}>
					<Stack direction="column" spacing={2}>
						<Typography variant="h5">{type === "create" ? "Create Product" : `Edit Product ID: ${id}`}</Typography>
						{sendingError && <Alert severity="error">{sendingError}</Alert>}
						<TextField
